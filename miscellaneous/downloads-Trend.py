...
data = [
    ...
    ("2025-11-10", 161, "1.5.1"),
    ("2025-11-13", 703, "1.5.2"),
    ("2025-12-07", 556, "1.5.3"),
    ("2025-12-30", 66, "1.6.0"),
    ("2025-12-30", 270, "1.6.1"),
    ("2026-01-05", 512, "1.6.2"),
    ("2026-01-16", 303, "1.6.3"),
    ("2026-01-21", 77, "1.7.0"),
    ("2026-01-22", 193, "1.7.1"),
    ("2026-01-24", 343, "1.7.2"),
    ("2026-01-30", 313, "1.7.3"),
    ("2026-02-05", 277, "1.7.4"),
    ("2026-02-10", 227, "1.7.5"),
    ("2026-02-12", 658, "2.0.0"),
    ("2026-02-28", 981, "2.0.1"),
    ("2026-04-18", 249, "2.1.0"),
    ("2026-04-21", 14, "2.2.0"),
    ("2026-04-21", 877, "2.2.1"),
    ("2026-05-18", 11, "2.2.2"),
    ("2026-05-18", 7, "2.2.3"),
    ("2026-05-18", 493, "2.2.4"),
    ("2026-05-27", 726, "2.2.5"),
    ("2026-06-12", 385, "2.2.6"),
    ("2026-06-19", 11, "2.2.7"),
    ("2026-06-19", 309, "2.2.8"),
    ("2026-06-25", 516, "2.2.9"),
    ("2026-07-07", 0, "2.3.0"),
]
...
for i in range(len(dates_plot)):
    ...
    if version.endswith('.0'):
        ax.annotate(f'{version}', 
                    ...
                    xytext=(-5, 15) if (version == "1.2.0" or version == "2.2.0") else (-5, 0), 
